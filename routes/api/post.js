...
//Get single post by id api/post/:id
//private
...
//check user
        ...
        {
            return res.status(401).json({msg:"User not aurthorised"});
        }
